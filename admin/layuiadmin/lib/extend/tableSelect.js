    ...
    tableSelect.prototype.render = function (opt) {
        ...
        elem.off('click').on('click', function(e) {
            ...
            form.on('submit(tableSelect_btn_search)', function(data){
            	data.field.token=layui.data("userInfo").token;
              var whereVal = data.field.where;
            	//会员
//          	if(queryCt==="huiyuan"){
//          		data.field.where = "eq|nickname="+whereVal;
//          	}else if(queryCt==="zhuti"){//主题
////          		data.field.where = "like|nickname=%"+whereVal+"%";
//          	}else if(queryCt==="huodong"){
//              data.field.where = "like|title="+whereVal;
//            }
